...
export const PillIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m7.875 14.25 1.25-1.25a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 6.375 4.5l-1.25 1.25m11.25 0 1.25-1.25a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5A3.375 3.375 0 0 0 11.625 4.5l-1.25 1.25m-3.75 11.25a3.375 3.375 0 0 0 3.375 3.375h1.5a1.125 1.125 0 0 1 1.125 1.125v1.5a3.375 3.375 0 0 0-4.5 3.375l-1.25-1.25m3.75-11.25a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-4.5-3.375l-1.25 1.25" />
    </svg>
);

export const StoreIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0 1 14.25 12h.5a.75.75 0 0 1 .75.75v7.5m-7.5-7.5V21a.75.75 0 0 0 .75.75h5.5a.75.75 0 0 0 .75-.75v-7.5m-7.5-4.5h4.5m-4.5 0a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75m-4.5 0v-.75a.75.75 0 0 1 .75-.75h3a.75.75 0 0 1 .75.75v.75m-6.75-4.5H7.5a.75.75 0 0 0 .75-.75V4.5a.75.75 0 0 0-.75-.75H5.25a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Zm-.75-4.5h10.5a.75.75 0 0 0 .75-.75V4.5a.75.75 0 0 0-.75-.75H5.25a.75.75 0 0 0-.75.75v3.75c0 .414.336.75.75.75Z" />
    </svg>
);
...
export const ClipboardListIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75V6.108c0-.231-.035-.454-.1-.664m-5.801 0A48.255 48.255 0 0 1 6.375 5.25c-1.128.094-1.976 1.057-1.976 2.192v12.15c0 1.211.933 2.175 2.121 2.247A48.337 48.337 0 0 0 12 21.75c2.686 0 5.26-.43 7.625-1.254 1.188-.072 2.121-1.036 2.121-2.247V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08" />
  </svg>
);
